...
Technical documentation for AI Codebase Copilot. Start with the root README, then use this index for deeper implementation details.
...
- Keep the root README high-level.
- Put implementation detail only in `docs/`.
- Update links whenever docs are moved or renamed.
- Remove duplicate markdown files instead of maintaining parallel versions.
