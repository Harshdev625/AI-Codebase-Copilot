...
export default function RepositoriesPage() {
  ...
  useEffect(() => {
    const pid = localStorage.getItem("aicc_project_id") || "";
    setProjectId(pid);
    if (pid) fetchRepos(pid);
  }, []);
    ...
    <div className="animate-fade-in space-y-6">
      ...
      <div className="card flex items-center gap-3 py-3">
        ...
        <input
          ...
          value={projectId}
          onChange={(e) => { setProjectId(e.target.value); localStorage.setItem("aicc_project_id", e.target.value); }}
        />
