...
export function SettingsPanel() {
  ...
  React.useEffect(() => {
    // Sync with document class for theme
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-y-auto custom-scrollbar bg-surface">
      <div className="p-4 space-y-6">
        ...
        {/* Backend Settings (Hidden/Unsupported) */}
        <section className="space-y-3 pt-4 border-t border-border/50">
           <p className="text-[10px] text-muted-foreground italic pl-6">
             Backend-specific settings (e.g., model configurations, retention policies) are currently managed via environment variables. Dynamic configuration will be supported in a future update.
           </p>
        </section>
